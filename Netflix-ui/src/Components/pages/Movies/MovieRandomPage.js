...
import '../TvShows/TvRandompage.css'


function MovieRandomPage({movie}) {
...
//  }, 5000);
  ...
  return (
    <div>
     ...
     <div style={{background:'black'}}><MovieSlider movie={movie} /></div>
    </div>
  )
}

export default React.memo(MovieRandomPage);
