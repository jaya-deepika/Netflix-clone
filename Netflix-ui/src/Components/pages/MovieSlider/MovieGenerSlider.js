...
function MovieGenerSlider({genreId,moviedata}) {
  ...
  return (
    <div style={{position:'relative',overflow:"hidden",backgroundColor:'black',paddingTop:'80px',height:'100vh'}}>
...
export default MovieGenerSlider
