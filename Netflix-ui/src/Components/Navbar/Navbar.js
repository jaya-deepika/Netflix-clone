  ...
  return (
    <div className='navbarSection'>
        ...
        <div className='buttons'>
                {/* <button className='languageButton'>Language</button>
            ...
            <div className="dropdown__container">
              ...
              <HiTranslate className='hiiplaybuttonicon'/>
              <select
                name="languages"
                id="languagesSelect"
                className="language_drop_down">
                <option value="english"  className='optionbox'>
                  English
                </option>
                <option value="hindi" className='optionbox'>Hindi</option>
              </select>
            </div>
          </div>
          <div className="nav__item">
            <button className="signin__button" onClick={handleSignInClick}>Sign in</button>
          </div>
          </div>
        </div>
    </div>
